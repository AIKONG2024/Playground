...
print(type(b2))  # <class 'tuple'> 원소가 하나있을때 점을 찍어야 튜플로 인식.

# 인덱싱
print(">>>>>>>")
print(" d - ", d[1])  # d - 1000
print(" d - ", d[0] - d[1] - d[1])  # d - -1900
...
print("a - ", a.count(3))  # a -  1 해당 원소의 갯수를 반환도 가능.
...
(x1, x2, x3, x4) = t  # x1, x2, x3, x4 괄호가 없어도 똑같음.
