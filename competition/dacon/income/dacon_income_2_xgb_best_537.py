...
while 1 :
    ...
    SEED = random.randint(0,300000000)
    print('==============================')
    print('[seed] : ', SEED)
    #read 
    ...
    # [score] :  530.7380532958175
        ...
        submission_csv.to_csv(path + f"sample_submission_pred{save_name}_{score}_{SEED}.csv", index=False)
        # break
...
# [seed] :  272456415
# [score] :  536.4740142915304

# seed] :  123223233
# [score] :  536.6875909229828